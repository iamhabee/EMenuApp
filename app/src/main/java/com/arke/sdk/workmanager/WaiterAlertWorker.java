...
public class WaiterAlertWorker extends Worker {
    ...
    public void queryPendingOrders() {
        ...
        query.whereEqualTo("waiter_received_notif", false);
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null){
                    ...
                    if(mMessages.size() > 0) {
                        ...
                        String title = getInputData().getString(EXTRA_TITLE, "Order Updated");
                        ...
                        for (ParseObject message : mMessages) {
                            message.put("waiter_received_notif", true);
                            message.saveEventually();
                            Log.d("Waiter", String.valueOf(username));
                        }
//                        KitchenOrdersFragment.fetchIncomingOrders(0);
                    }
