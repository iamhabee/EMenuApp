...
public class RoundedImageView extends DynamicHeightImageView {
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                EMenuLogger.w(TAG, "Unable to find resource: " + mResource);
                // Don't try again.
                mResource = 0;
            }
        }
     ...
     * @return the radius.
     */
    public float getCornerRadius(@EMenuRoundedImageCorner int corner) {
     ...
     */
    public void setCornerRadiusDimen(@EMenuRoundedImageCorner int corner, @DimenRes int resId) {
     ...
     */
    public void setCornerRadius(@EMenuRoundedImageCorner int corner, float radius) {
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
        if (mCornerRadii[EMenuRoundedImageCorner.TOP_LEFT] == topLeft
                && mCornerRadii[EMenuRoundedImageCorner.TOP_RIGHT] == topRight
                && mCornerRadii[EMenuRoundedImageCorner.BOTTOM_RIGHT] == bottomRight
                && mCornerRadii[EMenuRoundedImageCorner.BOTTOM_LEFT] == bottomLeft) {
            return;
        }

        mCornerRadii[EMenuRoundedImageCorner.TOP_LEFT] = topLeft;
        mCornerRadii[EMenuRoundedImageCorner.TOP_RIGHT] = topRight;
        mCornerRadii[EMenuRoundedImageCorner.BOTTOM_LEFT] = bottomLeft;
        mCornerRadii[EMenuRoundedImageCorner.BOTTOM_RIGHT] = bottomRight;
